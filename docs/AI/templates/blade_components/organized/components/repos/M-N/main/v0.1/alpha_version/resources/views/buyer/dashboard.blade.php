...
<div class="container-fluid">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-right-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">المفضلة</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_favorites'] }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('buyer.orders') }}" class="btn btn-primary btn-sm">عرض جميع الطلبات</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="text-center py-4">
                        ...
                        <a href="{{ route('home') }}" class="btn btn-primary">تسوق الآن</a>
                    </div>
                    @endif
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">المنتجات المفضلة</h6>
                    <a href="{{ route('buyer.favorites') }}" class="btn btn-primary btn-sm">عرض جميع المفضلة</a>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('product', $product->slug) }}" class="btn btn-primary btn-sm">عرض المنتج</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="text-center py-4">
                        ...
                        <p class="text-gray-500">لا توجد منتجات في المفضلة</p>
